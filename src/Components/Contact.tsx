    ...
    <section className="py-16 mt-28 lg:section" id="contact">
      <div className="w-[90%] mx-auto">
        <div className="flex flex-col lg:flex-row">
          <motion.div {...animationProps}  className="flex-1 flex justify-start items-center">
            <div className="">
          ...
          <motion.form  onSubmit={handleSubmit}  {...animationProps}  className="flex-1 border border-[#5a5a5a] rounded-2xl flex flex-col gap-y-6 pb-24 p-6 items-start bg-[#181818]">
